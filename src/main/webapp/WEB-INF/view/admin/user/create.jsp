                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form action="/admin/user/create" method="post"
                                                modelAttribute="newsUser" class="row" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3  col-12 col-md-6">
                                                    <c:set var="errorPassword">
                                                        <form:errors path="pasword" cssClass="invalid-feedback" />
                                                    </c:set>
                                                    <label for="" class="form-label ">Password:</label>
                                                    <form:input type="password" name="" id=""
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-6 col-12 mx-auto">
                        <h3>Create User</h3>
                        <hr>
                        <form:form action="/admin/user/create" method="post" modelAttribute="newsUser">
                            <div class="mb-3">
                                <form:input type="hidden" class="form-control" path="id"/>
                            </div>
                            <div class="mb-3">
