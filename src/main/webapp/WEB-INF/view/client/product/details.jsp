                            ...
                            <div class="">
                                <nav class="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Chi tiết sản phầm</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-lg-8 col-xl-9">
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- 2 ô input này sẽ tự động cập nhật giá trị cho chúng ta  -->
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>Lenove</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
